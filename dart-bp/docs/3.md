...
4. Verifies correctness of $State_{old_r}$ by checking:
   ...
   $$(s^j_r + s^j.c).G_6 + (b_{0_{blinding}} + b_0.c).H_0 \stackrel{?}{=} bal_{0_r}.G_1 + cnt_r.G_2 + \rho_r.G_4 + $$
   $$\rho^i_r.G_5 + s^j_r.G_6  + b_{0_{blinding}}.H_0 + (State_{old_r} - AK - at.G_3 - N - id.G_7).c$$
