...
The state is a Pedersen commitment as well, but contrary to non fee paying accounts, this doesn't have $counter$ and $id$ and also nullifier secret keys are simpler.
