...
2. Verifies correctness of $State_0$ by checking:
   ...
   $$\implies (\rho_r + \rho.c).G_5 + (s_r + s.c).G_6 \stackrel{?}{=} \rho_r.G_5 + s_r.G_6 + (State_0 - AK - balance.G_1 - at.G_3).c$$
...
4. Verifies correctness of $State_{old_r}$ by checking:
   ...
   $$(b_{0_r} + b_0.c).H_0 \stackrel{?}{=} bal_{1_r}.G_1 + \rho_r.G_5 + s_r.G_6 + b_{0_r}.H_0 + (State_{old_r} + v.G_1 - AK - at.G_3).c$$
...
5. Verifies correctness of $State_{new}$ by checking:
   ...
   $$\implies (bal_{1_r} + bal_1.c).G_1 + (\rho'_r + \rho'.c).G_5 + (s'_r + s'.c).G_6 \stackrel{?}{=} bal_{1_r}.G_1 + \rho'_r.G_5 + s'_r.G_6 + (State_{new} - AK - at.G_3).c$$
...
4. Verifies correctness of $State_{old_r}$ by checking:
   ...
   $$(b_{0_r} + b_0.c).H_0 \stackrel{?}{=} sk_r.G_{Aff} + bal_{1_r}.G_1 + \rho_r.G_5 + s_r.G_6 + b_{0_r}.H_0 + (State_{old_r} + v.G_1 - at.G_3).c$$
...
5. Verifies correctness of $State_{new}$ by checking:
   ...
   $$(s'_r + s'.c).G_6 \stackrel{?}{=} sk_r.G_{Aff} + bal_{1_r}.G_1 + \rho'_r.G_5 + s'_r.G_6 + (State_{new} - at.G_3).c$$
