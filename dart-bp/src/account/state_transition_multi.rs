...
use curve_tree_relations::curve_tree::{Root, SelRerandParameters, SelectAndRerandomizeMultiPath};
...
mod tests {
    ...
    use crate::account::{
        AccountCommitmentKeyTrait, AccountState, AccountStateBuilder,
    ...
    fn get_batched_tree_with_account_comms<const L: usize, const M: usize>(
    ...
    fn test_multi_asset_state_transition_two_accounts() {
        ...
        const NUM_GENS: usize = 1 << 14; // Increased for 4 accounts
        const L: usize = 512;
        const M: usize = 2;
        ...
        let account_tree = get_batched_tree_with_account_comms::<L, M>(
            vec![
                &alice_account_1,
                &alice_account_2,
                &bob_account_1,
