...
use super::{AuthSigningKey, AuthSigningKeys, PallasA, PallasScalar, WrappedCanonical};

type BPAuthProofOnlySks = crate::AuthProofOnlySks<PallasA>;
type BPAuthProofOnlySk = crate::AuthProofOnlySk<PallasA>;
type BPAuthProofAffirmation = crate::account::AuthProofAffirmation<PallasA>;
type BPAuthProofFeePayment = crate::fee_account::AuthProofFeePayment<PallasA>;
